...
export const personalInfo = {
    ...
    email: "contact@example.com", // You should update this
...
export const skills: SkillCategory[] = [
    ...
    {
        title: "UI/UX Design",
        skills: ["Figma", "Adobe XD", "Wireframing", "Prototyping", "User Research", "Visual Design"]
    },
    {
        title: "Tools & Data",
        skills: ["Git/GitHub", "MySQL", "MSSQL", "Google Sheets", "Microsoft Excel"]
    }
];
