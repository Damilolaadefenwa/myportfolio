...
- `App.tsx`, `index.tsx` — application entry and routing
- `services/` — example data/service logic

Feel free to explore the source to see how components are composed and typed.
